    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-main header sticky-top">
        <div class="container navbar-container">
            <a class="navbar-brand" href="https://moja.link/">
                ...
                <!-- <img class="img-fluid logo" src="assets/images/moja_logo_282_187.png"> -->
            </a>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="d-flex justify-content-center">
                    ...
                    <!-- "https://moja.link/assets/images/moja_logo_282_187.png" -->
                    <!-- <img class="img-fluid logo-hero" src="{{ url('assets/images/Expanded.png') }}"> -->
                    <img class="img-fluid logo-hero" src="https://moja.link/assets/images/Expanded.png">
                </div>
